...
align features to 2\,Hz, and train on 30-second windows using a single
linear frame-level head.  Toyama et al. probe the framewise encoder
sequence; our global-token inputs are controlled extensions evaluated
with the same folds, windows, optimisation, head, and post-processing.
For boundary
